...
namespace Pendencias.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var id = (((System.Security.Claims.ClaimsIdentity)User.Identity).Claims).ToList()[1].Value;
            var userInfo = gerenciadorDeLogin.Database.SqlQuery<Usuario>("SELECT * FROM LOGIN WHERE ID = '" + id + "'");
        ...
        public ActionResult ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var id = (((System.Security.Claims.ClaimsIdentity)User.Identity).Claims).ToList()[1].Value;
            var userInfo = gerenciadorDeLogin.Database.SqlQuery<Usuario>("SELECT * FROM LOGIN WHERE ID = '" + id + "'");
            if (userInfo.First().Password != model.OldPassword)
            {
                return ManageLogins(ManageMessageId.Error);
            }

            gerenciadorDeLogin.Database.ExecuteSqlCommand("UPDATE LOGIN SET Password = '" + model.NewPassword + "'WHERE ID = '" + id + "'");
